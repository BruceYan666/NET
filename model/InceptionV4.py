...
class InceptionV4(nn.Module):
    ...
    def __init__(self, A, B, C, k=192, l=224, m=256, n=384, class_nums=10):
        ...
        output_channels = self.reduction_a.output_channels#k,l,m,n是变量，output_channels不固定
    ...
    @staticmethod  #用于修饰类中的方法,可以在不创建类实例的情况下调用方法,静态方法不可以引用类中的属性或方法，其参数列表也不需要约定的默认参数self
